...
Stable MCP host contract for `wg21-wiki-mcp` **0.2.0**. Tool names, parameter
...
| Parameter | Type | Default | Description |
| --- | --- | --- | --- |
| `namespace` | `int` | required | Required. |
